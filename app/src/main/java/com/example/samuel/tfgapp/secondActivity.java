...
public class secondActivity extends AppCompatActivity {
    ...
    private void prepareDetail() throws JSONException{
        ...
        grapMaker = new HHRRBySexAndPeriod(jsonArray);
    ...
    private void prepareTable(String key, String clss) throws JSONException{
        ...
        for (int i = 0; i <sortedJsonArray.length(); i++) {
            ...
            String y = Integer.toString(sortedJsonArray.getJSONObject(i).getInt("Years"));
            years.setText(y);
            years.setGravity(Gravity.CENTER);
            TextView sex = new TextView(this);
            sex.setText(sortedJsonArray.getJSONObject(i).getString("Sex"));
            sex.setGravity(Gravity.CENTER);
            TextView europe = new TextView(this);
            String e = Double.toString(sortedJsonArray.getJSONObject(i).getDouble("EU-28"));
            europe.setText(e);
            europe.setGravity(Gravity.CENTER);
            TextView spain = new TextView(this);
            String s = Double.toString(sortedJsonArray.getJSONObject(i).getDouble("Spain"));
            spain.setText(s);
